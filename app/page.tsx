...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Funkcja pomocnicza wewnątrz modułu - bezpieczna dla TypeScripta
    const uploadToAzure = async (url: string, fileToUpload: File) => {
    ...
    try {
      ...
      setStatusMessage("Nie udało się przesłać zdjęć. Upewnij się, że ustawienia CORS w Azure są włączone.");
    } finally {
      setUploading(false);
    }
  };
